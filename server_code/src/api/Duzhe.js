...
export default ({ config, db }) => {
	...
	api.get('/group/:columnName', async (req, res) => {
		...
		try {
			...
			// let tableName = "duzhe"
			let where = " WHERE 1 = 1 "
			sql = "SELECT COUNT(*) AS total, " + columnName + " FROM duzhe " + where + " GROUP BY " + columnName + " LIMIT 10" 
	...
	api.get('/value/:xColumnName/:yColumnName', async (req, res) => {
		...
		try {
			...
			sql = "SELECT " + xColumnName + ", SUM(" + yColumnName + ") AS total FROM duzhe " + where + " GROUP BY " + xColumnName + " DESC LIMIT 10"
