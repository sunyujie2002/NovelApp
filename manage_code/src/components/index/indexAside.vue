<template>
	<div>
		<el-scrollbar wrap-class="scrollbar-wrapper" class="menu_scrollbar">
			<el-menu :default-openeds="[]" :unique-opened="false" :default-active="$route.fullPath" :router="true" class="menu_view"
				:collapse="collapse" unique-opened="true">
				<el-sub-menu :index="'/'" @click="menuHandler('')">
					<template #title>
				...
				<el-sub-menu v-for=" (menu, index) in menuList.backMenu" :key="menu.menu" :index="index + 2 + ''">
					...
					<el-menu-item class="menu_item_view" v-for=" (child, sort) in menu.child" :key="sort"
						:index="'/'+child.tableName" @click="menuHandler(child.tableName, child.menuJump)">{{ child.menu
						}}
					</el-menu-item>
				</el-sub-menu>
			</el-menu>
