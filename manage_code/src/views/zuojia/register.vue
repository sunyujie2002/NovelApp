	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">作家账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.zuojiazhanghao" 
						 placeholder="请输入作家账号"
						 type="text"
						/>
				</div>
				<div class="list_item">
					<div class="list_label">作家姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.zuojiaxingming" 
						 placeholder="请输入作家姓名"
						 type="text"
						/>
				</div>
				...
				<div class="list_item">
					<div class="list_label">作家简介：</div>
					<el-input class="list_inp"
						 v-model="registerForm.zuojiajianjie" 
						 placeholder="请输入作家简介"
						 type="text"
						/>
				</div>
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.zuojiazhanghao)){
