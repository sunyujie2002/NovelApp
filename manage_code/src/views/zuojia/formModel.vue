				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="作家简介" prop="zuojiajianjie">
							<el-input class="list_inp" v-model="form.zuojiajianjie" placeholder="作家简介"
								 type="text" 								:readonly="!isAdd||disabledForm.zuojiajianjie?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='zuojiajianjie'){
					form.value.zuojiajianjie = row[x];
					disabledForm.value.zuojiajianjie = true;
					continue;
				}
			}
			if(row){
