	...
	<div>
		<div class="login_view">
			<el-form :model="loginForm" class="login_form">
				<div class="title_view">基于Vue+Node的小说阅读网站的设计与实现登录</div>
				...
				<div class="btn_view">
					...
					<el-button class="register" type="primary" @click="handleRegister('zuojia')">注册作家</el-button>
				</div>
			</el-form>
		</div>
...
// 		method: 'get'
// 	}).then(res => {
// 		loginForm.value.avatar = res.data.data?.zhaopian
// 		context?.$toolUtil.storageSet("avatar", loginForm.value.avatar);
// 		store.dispatch('setAvatar', loginForm.value.avatar)
// 	})
// }
//初始化
const init = () => {
