		...
		<div class="app-contain">
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button type="success" @click="addClick"
						v-if="btnAuth('discussxiaoshuoxinxi', '新增')">新增</el-button>
					<el-button type="primary" :disabled="selRows.length == 1 ? false : true" @click="editClick"
						v-if="btnAuth('discussxiaoshuoxinxi', '修改')">修改</el-button>
			...
			<el-table v-loading="listLoading" border :stripe='false' @selection-change="handleSelectionChange"
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left"
					header-align="left">
					<template #default="scope">
						<el-button v-if="btnAuth('discussxiaoshuoxinxi', '查看评论')" type="warning"
...
//基础信息
const tableName = 'discussxiaoshuoxinxi'
const formName = '小说信息评论表'
...
const commentClick = (id) => {
	context?.$router.push('/discussdiscussxiaoshuoxinxi?refid=' + id)
}
