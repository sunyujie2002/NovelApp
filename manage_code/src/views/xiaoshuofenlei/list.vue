	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form">
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.xiaoshuofenlei" placeholder="小说分类"
								clearable>
							</el-input>
						</div>
					</div>
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('xiaoshuofenlei', '新增')">新增</el-button>
					<el-button v-if="btnAuth('xiaoshuofenlei', '查看')" type="info"
			...
			<el-table v-loading="listLoading" border :stripe='false' @selection-change="handleSelectionChange"
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left"
					header-align="left">
					<template #default="scope">
						<el-button type="info" v-if="btnAuth('xiaoshuofenlei', '查看')"
...
//基础信息
const tableName = 'xiaoshuofenlei'
const formName = '小说分类'
