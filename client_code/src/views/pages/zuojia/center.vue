		...
		<div class="usersView">
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						<el-col :span="12">
							<el-form-item prop="zuojiazhanghao" label="作家账号">
								<el-input class="list_inp" v-model="userForm.zuojiazhanghao" placeholder="作家账号" readonly></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item prop="zuojiaxingming" label="作家姓名">
								<el-input class="list_inp" v-model="userForm.zuojiaxingming" placeholder="作家姓名" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item prop="zuojiajianjie" label="作家简介">
								<el-input class="list_inp" v-model="userForm.zuojiajianjie" placeholder="作家简介" ></el-input>
							</el-form-item>
						</el-col>
					</el-row>
